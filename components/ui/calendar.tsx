    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 text-zinc-300 hover:text-white",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse space-y-1",
        head_row: "flex",
        head_cell: "text-zinc-400 rounded-md w-9 font-normal text-[0.75rem]",
        ...
        day_selected:
          "bg-lime-300 text-slate-950 hover:bg-lime-200 hover:text-slate-950 focus:bg-lime-200 focus:text-slate-950",
        day_today: "bg-zinc-700 text-zinc-100",
        day_outside:
          "day-outside text-zinc-500 opacity-50 aria-selected:bg-zinc-800/50 aria-selected:text-zinc-400 aria-selected:opacity-30",
